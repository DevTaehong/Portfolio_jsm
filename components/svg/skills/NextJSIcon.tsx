...
const NextJSIcon = ({ isCaseDetailPage }: { isCaseDetailPage?: boolean }) => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          <g clipPath="url(#clip0_3718_256)" className="dark:hidden">
            <mask
              id="mask0_3718_256"
      ...
      >
        <svg
          className={`hidden h-[3.29831rem] w-[3.29831rem] dark:block sm:h-[6.25rem] sm:w-[6.25rem] ${
            isCircleHovered || (isCaseDetailPage && "drop-shadow-skill")
          } `}
          viewBox="0 0 103 100"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          ...
          <g clipPath="url(#clip0_3313_11459)">
            <path
              ...
              className={`fill-[#778295] ${
                isCircleHovered || (isCaseDetailPage && "dark:fill-white900")
              }`}
            />
          </g>
          <defs>
