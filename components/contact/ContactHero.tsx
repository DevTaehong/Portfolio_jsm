    ...
    <section className="bg-white800 px-6 py-12 dark:bg-black300">
      <div className="flex flex-col items-center gap-6 text-center md:gap-[3.5rem] 2xl:mx-auto 2xl:max-w-[90rem]">
        <div className="flex flex-col gap-5 md:gap-8">
          <h1 className="mobileHeading1 dark:text-white900 md:text-[4rem] md:leading-[5.2rem] md:tracking-[-0.04rem]">
          ...
          <p className="smallRegular max-w-[21.125rem] text-white500 dark:text-white800 md:max-w-[44rem] md:text-[1.25rem] md:leading-[1.875rem]">
